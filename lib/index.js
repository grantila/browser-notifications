...
function makeDefault( func )
{
	module.exports[ func ] = function( )
	{
		if ( !global.Promise )
			...
			// supporting Notifications will most likely support Promises.
			throw new Error( "The platform doesn't natively support promises" );

		var args = [ ].slice.call( arguments );
		return module.exports( global.Promise )[ func ].apply( null, args );
	}
}
...
makeDefault( 'isPermitted' );
makeDefault( 'requestPermissions' );
makeDefault( 'create' );
makeDefault( 'send' );
